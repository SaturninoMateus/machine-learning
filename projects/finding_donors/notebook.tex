...
{\color{incolor}In [{\color{incolor}1}]:} \PY{c+c1}{\PYZsh{} Import libraries necessary for this project}
        ...
        \PY{n}{display}\PY{p}{(}\PY{n}{data}\PY{o}{.}\PY{n}{head}\PY{p}{(}\PY{n}{n}\PY{o}{=}\PY{l+m+mi}{5}\PY{p}{)}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}2}]:} \PY{c+c1}{\PYZsh{} TODO: Total number of records}
        ...
        \PY{n}{n\PYZus{}greater\PYZus{}50k} \PY{o}{=} \PY{n}{data}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{income}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{.}\PY{n}{value\PYZus{}counts}\PY{p}{(}\PY{p}{)}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZgt{}50K}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
        
        \PY{c+c1}{\PYZsh{} TODO: Number of records where individual\PYZsq{}s income is at most \PYZdl{}50,000}
        \PY{n}{n\PYZus{}at\PYZus{}most\PYZus{}50k} \PY{o}{=} \PY{n}{data}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{income}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{.}\PY{n}{value\PYZus{}counts}\PY{p}{(}\PY{p}{)}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZlt{}=50K}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
        
        \PY{c+c1}{\PYZsh{} TODO: Percentage of individuals whose income is more than \PYZdl{}50,000}
        \PY{n}{greater\PYZus{}percent} \PY{o}{=} \PY{n}{n\PYZus{}greater\PYZus{}50k}\PY{o}{*}\PY{l+m+mi}{100}\PY{o}{/}\PY{n}{n\PYZus{}records}
...
{\color{incolor}In [{\color{incolor}6}]:} \PY{c+c1}{\PYZsh{} TODO: One\PYZhy{}hot encode the \PYZsq{}features\PYZus{}log\PYZus{}minmax\PYZus{}transform\PYZsq{} data using pandas.get\PYZus{}dummies()}
        ...
        \PY{n}{income} \PY{o}{=} \PY{n}{income\PYZus{}raw}\PY{o}{.}\PY{n}{replace}\PY{p}{(}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZlt{}=50K}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZgt{}50K}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}
...
\end{itemize}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{n}{TP} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{n}{income}\PY{p}{)} \PY{c+c1}{\PYZsh{} Counting the ones as this is the naive case. Note that \PYZsq{}income\PYZsq{} is the \PYZsq{}income\PYZus{}raw\PYZsq{} data }
        ...
        \PY{n}{accuracy} \PY{o}{=} \PY{n}{n\PYZus{}greater\PYZus{}50k}\PY{o}{/}\PY{n}{n\PYZus{}records}
        \PY{n}{recall} \PY{o}{=} \PY{n}{TP}\PY{o}{/}\PY{p}{(}\PY{n}{TP}\PY{o}{+}\PY{n}{FN}\PY{p}{)} \PY{c+c1}{\PYZsh{} in this naive predictor will be 1}
        ...
        \PY{n}{fscore} \PY{o}{=} \PY{p}{(}\PY{l+m+mi}{1}\PY{o}{+}\PY{n}{beta}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2}\PY{p}{)}\PY{o}{*}\PY{n}{precision}\PY{o}{*}\PY{n}{recall}\PY{o}{/}\PY{p}{(}\PY{n}{beta}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{precision}\PY{o}{+}\PY{n}{recall}\PY{p}{)}
...
\texttt{beta} parameter!
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} Import two metrics from sklearn \PYZhy{} fbeta\PYZus{}score and accuracy\PYZus{}score.  }
        \PY{c+c1}{\PYZsh{} We already did this above, but do it again as requested :)}
        ...
        \PY{l+s+sd}{    \PYZsq{}\PYZsq{}\PYZsq{}}
            ...
            \PY{c+c1}{\PYZsh{} Fit the learner to the training data using slicing with \PYZsq{}sample\PYZus{}size\PYZsq{}}
            \PY{n}{start} \PY{o}{=} \PY{n}{time}\PY{p}{(}\PY{p}{)} \PY{c+c1}{\PYZsh{} Get start time}
            \PY{n}{learner}\PY{o}{.}\PY{n}{fit}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{o}{.}\PY{n}{head}\PY{p}{(}\PY{n}{sample\PYZus{}size}\PY{p}{)}\PY{p}{,} \PY{n}{y\PYZus{}train}\PY{o}{.}\PY{n}{head}\PY{p}{(}\PY{n}{sample\PYZus{}size}\PY{p}{)}\PY{p}{)}
            ...
            \PY{c+c1}{\PYZsh{} Get the predictions on the test set,}
            ...
            \PY{c+c1}{\PYZsh{} Compute accuracy on the first 300 training samples}
            ...
            \PY{c+c1}{\PYZsh{} Compute accuracy on test set}
            ...
            \PY{c+c1}{\PYZsh{} Compute F\PYZhy{}score on the the first 300 training samples. We use previous beta}
            \PY{n}{results}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{f\PYZus{}train}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=} \PY{n}{fbeta\PYZus{}score}\PY{p}{(}\PY{n}{y\PYZus{}train}\PY{p}{[}\PY{p}{:}\PY{l+m+mi}{300}\PY{p}{]}\PY{p}{,} \PY{n}{predictions\PYZus{}train}\PY{p}{,} \PY{n}{beta}\PY{p}{)}
                
            \PY{c+c1}{\PYZsh{} Compute F\PYZhy{}score on the test set. We use previous beta}
            \PY{n}{results}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{f\PYZus{}test}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=} \PY{n}{fbeta\PYZus{}score}\PY{p}{(}\PY{n}{y\PYZus{}test}\PY{p}{,} \PY{n}{predictions\PYZus{}test}\PY{p}{,} \PY{n}{beta}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor} }]:} \PY{k+kn}{from} \PY{n+nn}{sklearn}\PY{n+nn}{.}\PY{n+nn}{naive\PYZus{}bayes} \PY{k}{import} \PY{n}{GaussianNB}
        ...
        \PY{n}{clf\PYZus{}B} \PY{o}{=} \PY{n}{DecisionTreeClassifier}\PY{p}{(}\PY{p}{)}
        \PY{n}{clf\PYZus{}C} \PY{o}{=} \PY{n}{SVC}\PY{p}{(}\PY{p}{)}
        ...
        \PY{n}{samples\PYZus{}10} \PY{o}{=} \PY{n+nb}{int}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{)}\PY{o}{/}\PY{l+m+mi}{10}\PY{p}{)}
        \PY{n}{samples\PYZus{}1} \PY{o}{=} \PY{n+nb}{int}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{)}\PY{o}{/}\PY{l+m+mi}{100}\PY{p}{)}
...
the following implementation may take some time to run!
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{k+kn}{import} \PY{n+nn}{pickle}\PY{o}{,} \PY{n+nn}{os}\PY{n+nn}{.}\PY{n+nn}{path}
        ...
        \PY{k}{def} \PY{n+nf}{f1}\PY{p}{(}\PY{n}{y\PYZus{}true}\PY{p}{,} \PY{n}{y\PYZus{}predict}\PY{p}{)}\PY{p}{:}
            \PY{k}{return} \PY{n}{fbeta\PYZus{}score}\PY{p}{(}\PY{n}{y\PYZus{}true}\PY{p}{,} \PY{n}{y\PYZus{}predict}\PY{p}{,} \PY{n}{beta}\PY{p}{)}
        
        \PY{c+c1}{\PYZsh{}If you enable, it can take more than 3h fit....}
        \PY{n}{IS\PYZus{}GRID\PYZus{}SEARCH} \PY{o}{=} \PY{l+m+mi}{0}
        \PY{k}{if} \PY{n}{IS\PYZus{}GRID\PYZus{}SEARCH}\PY{p}{:}
            \PY{c+c1}{\PYZsh{} Initialize the classifier}
            \PY{n}{clf} \PY{o}{=} \PY{n}{SVC}\PY{p}{(}\PY{n}{random\PYZus{}state}\PY{o}{=}\PY{l+m+mi}{0}\PY{p}{)}
        
            \PY{c+c1}{\PYZsh{} Create the parameters list you wish to tune, using a dictionary if needed.}
            \PY{n}{parameters} \PY{o}{=} \PY{p}{\PYZob{}}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{C}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{6}\PY{p}{)}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{kernel}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{linear}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{poly}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{rbf}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{sigmoid}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{degree}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}\PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{6}\PY{p}{)}\PY{p}{\PYZcb{}}
        
            \PY{c+c1}{\PYZsh{} Make an fbeta\PYZus{}score scoring object using make\PYZus{}scorer()}
            \PY{n}{scorer} \PY{o}{=} \PY{n}{make\PYZus{}scorer}\PY{p}{(}\PY{n}{f1}\PY{p}{)}
            ...
            \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Fiting model...}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
            \PY{n}{grid\PYZus{}fit} \PY{o}{=} \PY{n}{grid\PYZus{}obj}\PY{o}{.}\PY{n}{fit}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{y\PYZus{}train}\PY{p}{)}
            \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Fiting process DONE!}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
        
            \PY{c+c1}{\PYZsh{} Get the estimator}
            \PY{n}{best\PYZus{}clf} \PY{o}{=} \PY{n}{grid\PYZus{}fit}\PY{o}{.}\PY{n}{best\PYZus{}estimator\PYZus{}}
            \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{best\PYZus{}clf.pkl}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{wb}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f}\PY{p}{:}
                \PY{n}{pickle}\PY{o}{.}\PY{n}{dump}\PY{p}{(}\PY{n}{best\PYZus{}clf}\PY{p}{,} \PY{n}{f}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{)}
        \PY{k}{else}\PY{p}{:}
            \PY{k}{if} \PY{n}{os}\PY{o}{.}\PY{n}{path}\PY{o}{.}\PY{n}{isfile}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{best\PYZus{}clf.pkl}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}\PY{p}{:}
                \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{best\PYZus{}clf.pkl}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{rb}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f}\PY{p}{:}
                    \PY{n}{best\PYZus{}clf} \PY{o}{=} \PY{n}{pickle}\PY{o}{.}\PY{n}{load}\PY{p}{(}\PY{n}{f}\PY{p}{)}
            \PY{k}{else}\PY{p}{:}
                \PY{k}{raise} \PY{n+ne}{Exception}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{No model! Please enable Grid search.}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} TODO: Import a supervised learning model that has \PYZsq{}feature\PYZus{}importances\PYZus{}\PYZsq{}}
        ...
        \PY{c+c1}{\PYZsh{} Import a supervised learning model that has \PYZsq{}feature\PYZus{}importances\PYZus{}\PYZsq{}}
        
        \PY{c+c1}{\PYZsh{} Train the supervised model on the training set }
        \PY{n}{model} \PY{o}{=} \PY{n}{DecisionTreeClassifier}\PY{p}{(}\PY{n}{criterion}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{entropy}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{n}{random\PYZus{}state}\PY{o}{=}\PY{l+m+mi}{0}\PY{p}{)}
...
do you think these features are more relevant?
    ...
    \textbf{Answer:} Wow! I did not expect that, lets see...
\emph{Hours-per-week:} In my head, i think it really influences but i
did not expected that much, i think i should map hours-per-week and
their education to understand better. \emph{Education number:}I think
this input is correlated with education, the higher the education is,
the higher is education-num, and have big contribution, as expected.
\emph{Capital Gain:} It seems that this capital gain is related to the
wealth, i did not expect that. \emph{Marital Status:} I really can't
figure out what this has related to the incomes. I think this feature
would
